...
import com.EIPplatform.model.dto.report.airemmissionmanagement.airautomonitoringstat.AirAutoMonitoringIncidentCreateDTO;
import com.EIPplatform.model.dto.report.airemmissionmanagement.airautomonitoringstat.AirAutoMonitoringIncidentDTO; // Giả sử có Response DTO (tương tự CreateDTO + Long id)
import com.EIPplatform.model.entity.report.airemmissionmanagement.AirEmissionData;
import com.EIPplatform.model.entity.report.airemmissionmanagement.AirAutoMonitoringIncident;
