...
import com.EIPplatform.model.dto.report.airemmissionmanagement.airautoqcvnexceedance.AirAutoQcvnExceedanceCreateDTO;
import com.EIPplatform.model.dto.report.airemmissionmanagement.airautoqcvnexceedance.AirAutoQcvnExceedanceDTO; // Giả sử có Response DTO (tương tự CreateDTO + Long id)
import com.EIPplatform.model.entity.report.airemmissionmanagement.AirEmissionData;
import com.EIPplatform.model.entity.report.airemmissionmanagement.AirAutoQcvnExceedance;
