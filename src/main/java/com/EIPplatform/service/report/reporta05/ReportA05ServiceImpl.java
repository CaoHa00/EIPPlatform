...
public class ReportA05ServiceImpl implements ReportA05Service {
    ...
    public byte[] generateReportFile(UUID reportId) throws Exception {
        ...
        data.put("legalRepresentative", business.getLegalRepresentative()); // ✅ SỬA LẠI KEY
        ...
        if (wasteWaterDataDTO != null) {
            data.put("ww_treatment_desc",
                    wasteWaterDataDTO.getTreatmentWwDesc() != null ? wasteWaterDataDTO.getTreatmentWwDesc() : "");
            // Nước thải sinh hoạt
            data.put("domestic_ww_cy",
                    wasteWaterDataDTO.getDomWwCy() != null ? wasteWaterDataDTO.getDomWwCy().toString() : "");
            data.put("domestic_ww_py",
                    wasteWaterDataDTO.getDomWwPy() != null ? wasteWaterDataDTO.getDomWwPy().toString() : "");
            data.put("domestic_ww_design",
                    wasteWaterDataDTO.getDomWwDesign() != null ? wasteWaterDataDTO.getDomWwDesign().toString() : "");
            // Nước thải công nghiệp
            data.put("industrial_ww_cy",
                    wasteWaterDataDTO.getIndustrialWwCy() != null ? wasteWaterDataDTO.getIndustrialWwCy().toString()
                            : "");
            data.put("industrial_ww_py",
                    wasteWaterDataDTO.getIndustrialWwPy() != null ? wasteWaterDataDTO.getIndustrialWwPy().toString()
                            : "");
