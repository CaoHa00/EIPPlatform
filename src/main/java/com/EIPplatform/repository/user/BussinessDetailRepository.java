...
@Repository
public interface BussinessDetailRepository extends JpaRepository<BusinessDetail, UUID> {
    Optional<BusinessDetail> findByUserAccountsContaining(UserAccount userAccount);

    Optional<BusinessDetail> findByUserAccounts_UserAccountId(UUID userAccountId);
    ...
    Optional<BusinessDetail> findByBusinessRegistrationNumber(String businessRegistrationNumber);
